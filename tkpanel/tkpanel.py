...
def firstActiveWin():
    ...
    if win and changed:
        ...
        sct = [get_window_name1(win), win] #.decode()
    ########## END ACTIVE WINDOW
firstActiveWin()
                            ...
                            if winName and winPid:
                                ...
                                if prop:
                                    ...
                                    if not newData in list_normal_win:
                                        ...
                                        self3.application.flist_desktop_windows3("add")
                        ...
                        if len(tmp_list) == len(list_normal_win) - 1:
                            ...
                            for el in list_normal_win:
                                ...
                                if str(right_hex(el[0])) not in tmp_list:
                                    ...
                                    self3.application.flist_desktop_windows3("remove")
                                    break
...
class Application(ttk.Frame):
    ...
    def flist_desktop_windows2(self):
        ...
        actual_virtual_desktop = self.factual_virtual_desktop()
    ...
    def flist_desktop_windows3(self, action_type):
        
        # find the actual virtual desktop
        actual_virtual_desktop = self.factual_virtual_desktop()
        #
        # self.list_id: wid - btn - desktop : it is not updated
        # list_normal_win : it is already updated
        # add a button
        if action_type == "add":
            tmp_list = []
            for el in self.list_id:
            ...
            for el2 in list_normal_win:
                # if in the current desktop
                if el2[2] == actual_virtual_desktop:
                    if el2[0] not in tmp_list:
                        ...
                        if len(el2[1]) > 13:
                            ...
                            btext = el2[1]
                        self.btn = ttk.Button(self.win_btns_frame, style="Color.TButton", text=btext, command=lambda x=el2[0]: self.fwinbtn(x))
                        self.btn.grid(row=0, column=self.i, ipady=vd_btn_pady, sticky="ns")
                        # add to self.list_id
                        self.list_id.append([el2[0], self.btn, el2[2]])
                        self.i += 1
                        #
    ...
    def create_widgets(self):
        ...
        self.vd_btn_list = []
        # track the change in the number of virtual desktops
        self.virt_desk_var = tk.IntVar()
        #self.virt_desk_var.set(virtual_desktops)
        global virt_desk
    ...
    # find the active virtual desktop
    def factual_virtual_desktop(self):
    ...
    def fvd(self, nvd):
        ...
        try:
            ...
            return
        # find the actual virtual desktop
        active_virtual_desktop = self.factual_virtual_desktop()
        #
...
############## THE MENU WINDOW ##############
    ...
    def on_enter(self, event):
        ...
        if self.last_lbl:
            # when the label loose the focus style to default
    ...
    def fsmenuWindow(self, label_widget):
        ...
        # submenu window height - 10 is pady*2
